...
arg.trans=[2 2;...
           ...
           4 4];
%reward prob by SE
arg.RWP=[1 0 .0 .0 .0 .0;... %reward rates at dfferent cond order
	     0 1 .0 .0 .0 .0;...
        .8 .2 .8 .8 .8 .8];
 
 %number of statistical environments administered
arg.SEN=[1 1 1 1 1];%SE*REPS;
arg.chance=0.125;%specify what is the a priori chance level to execute the task optimally (it can refer either to the entire trial or to single steps)
